...
public class Territory implements Selectable
{
    ...
    {   
        continentColor = Appearance.WORLD_COLOR;
        makeTransparent();
    ...
    public void makeTransparent() {  
        GreenfootImage img = Hexagon.createImage(Appearance.WORLD_COLOR);
        for(TerritoryHex hex : terrHexList){
    ...
    public void makeGreen() {
        GreenfootImage img = Hexagon.createImage(Appearance.SELECTION_COLOR);
        for(TerritoryHex hex : terrHexList){
